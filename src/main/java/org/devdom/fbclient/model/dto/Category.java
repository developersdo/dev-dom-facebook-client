...
@NamedQueries({
    ...
    @NamedQuery(name = "Category.findBySkills", query = "SELECT c FROM Category c WHERE c.skills = :skills")})
public class Category implements Serializable {
    ...
    public String toString() {
        return "org.devdom.fbclient.model.Category[ optionCategoryId=" + optionCategoryId + " ]";
    }
