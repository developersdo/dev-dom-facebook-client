...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Skillset.count", query = "SELECT 0,0, 'total', count(s.votes)   FROM Skillset s"),
    ...
    @NamedQuery(name = "Skillset.findByMenuVisibility", query = "SELECT s FROM Skillset s WHERE s.menuVisibility = :menuVisibility"),
...
public class Skillset implements Serializable {
    ...
    public String toString() {
        return "org.devdom.fbclient.model.Skillset[ id=" + id + " ]";
    }
